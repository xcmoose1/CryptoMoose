...
class MarketVisualization {
    constructor(chartInstance, bybitHandler, tradMarketsHandler) {
        this.chart = chartInstance;
        this.bybitHandler = bybitHandler;
        this.tradMarketsHandler = tradMarketsHandler;
    ...
    async updateCorrelationMatrix() {
        ...
        const correlations = await this.tradMarketsHandler.getCorrelations(assets);
    ...
    async updateOrderBook() {
        const orderBook = await this.bybitHandler.getOrderBook(this.currentSymbol);
